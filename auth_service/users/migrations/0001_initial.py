# Generated by Django 5.2.5 on 2025-10-06 15:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('root-admin', 'Root-Admin'), ('co-admin', 'Co-Admin'), ('hr', 'HR'), ('staff', 'Staff'), ('user', 'User'), ('carer', 'Carer'), ('client', 'Client'), ('family', 'Family'), ('auditor', 'Auditor'), ('tutor', 'Tutor'), ('assessor', 'Assessor'), ('iqa', 'IQA'), ('eqa', 'EQA'), ('recruiter', 'Recruiter'), ('team_manager', 'Team Manager')], default='carer', max_length=20)),
