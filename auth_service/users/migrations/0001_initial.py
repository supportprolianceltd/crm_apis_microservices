    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploaded_by_id', models.CharField(blank=True, max_length=36, null=True)),
                ...
                ('document_number', models.CharField(blank=True, max_length=20, unique=True)),
            ],
            options={
                'indexes': [models.Index(fields=['tenant_id', 'document_number'], name='idx_doc_tenant_number')],
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['tenant_id', 'user_id'], name='idx_ack_tenant_user')],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user', 'timestamp'], name='users_usera_user_id_bd4c6e_idx'), models.Index(fields=['action', 'timestamp'], name='users_usera_action_048900_idx'), models.Index(fields=['ip_address'], name='users_usera_ip_addr_20d9f6_idx')],
            },
        ),
        migrations.AddIndex(
