    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_of_kin_phone_number', models.CharField(blank=True, max_length=25)),
                ('next_of_kin_alternate_phone', models.CharField(blank=True, max_length=25)),
                ...
                ('preferred_otp_method', models.CharField(choices=[('email', 'Email'), ('phone', 'Phone')], default='email', help_text="User's preferred method for receiving OTP codes", max_length=10)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'tenant', 'is_read', 'created_at'], name='users_inapp_user_id_5c1f09_idx'),
        ),
        migrations.AddIndex(
            model_name='inappnotification',
            index=models.Index(fields=['tenant', 'created_at'], name='users_inapp_tenant__f4a5ec_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='passwordresettoken',
