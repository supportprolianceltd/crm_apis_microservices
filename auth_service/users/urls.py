...
#     DrivingRiskAssessmentView, LegalWorkEligibilityView, OtherUserDocumentsView, AllTenantsUsersListView
# )
...
#     path('users/all-tenants/', AllTenantsUsersListView.as_view(), name='all-tenants-users'),
# ]

# In auth_service/urls.py, update the urlpatterns to place the custom path before include(router.urls)
