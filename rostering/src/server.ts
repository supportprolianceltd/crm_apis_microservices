...
class RosteringServer {
  ...
  private setupRoutes(): void {
    ...
    this.app.use('/api/rostering/', createHealthRoutes());
    ...
    this.app.use('/api/rostering/sync', authenticate, createSyncRoutes(
      this.prisma,
      this.authSyncService, 
      this.tenantEmailConfigService,
      this.notificationService
    ));
    this.app.use('/api/rostering/emails', authenticate, createEmailRoutes(
      this.prisma,
      this.emailService,
      this.emailWorker
    ));
    ...
    this.app.get('/', (req: Request, res: Response) => {
      res.json({
        ...
        documentation: '/api/rostering/health'
      });
    });
