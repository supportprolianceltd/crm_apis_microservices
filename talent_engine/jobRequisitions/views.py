...
class JobRequisitionListCreateView(generics.ListCreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        from .serializers import get_user_data_from_request
        user_data = get_user_data_from_request(self.request)
        ...
        serializer.save(
            ...
            updated_by_details=user_data,  # Initial update = create
    ...
    def perform_update(self, serializer):
        ...
        serializer.save(
            ...
            approved_by_details=user_data if is_approval else serializer.instance.approved_by_details
        )
