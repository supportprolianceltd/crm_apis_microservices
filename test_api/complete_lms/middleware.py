...
class SimpleTenant:
    def __init__(self, tenant_data):
        ...
        self.schema_name = tenant_data.get('schema_name')
...
class SimpleUser:
    def __init__(self, payload):
        ...
        self.id = payload.get('id')  # ✅ Add this line
...
class CustomTenantSchemaMiddleware:
    ...
    def __call__(self, request):
        ...
        try:
            ...
            # Set tenant info on request for compatibility
            request.tenant = SimpleTenant({
                'schema_name': tenant_schema,
                'id': jwt_payload.get('tenant_id'),
                'name': jwt_payload.get('tenant_name', tenant_schema)
            })
