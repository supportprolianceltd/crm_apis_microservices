...
#     'job_applications.middleware.MicroserviceRS256JWTMiddleware',  # <-- Add this line
#     'django.contrib.auth.middleware.AuthenticationMiddleware',      # <-- Keep this after your JWT middleware
...
# TALENT_ENGINE_URL = env('TALENT_ENGINE_URL', default='http://job_applications:8002')
